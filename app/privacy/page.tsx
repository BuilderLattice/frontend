    ...
    return (
        <div className="container mt-20 mx-auto py-8 px-4 max-w-3xl">
            <Card>
                ...
                <CardContent>
                    <p className="mb-6">
                        Welcome to Builder lattice. This Privacy Policy outlines how we collect, use, and protect your personal information.
                    ...
                    <Accordion type="single" collapsible className="w-full">
                        ...
                        <AccordionItem value="future-compensation">
                            ...
                            <AccordionContent>
                                <p>We value your contribution to our platform. In the near future, we plan to implement a compensation program for users who provide their profile data. Please note:</p>
                                <ul className="list-disc pl-6 mt-2 space-y-2">
                                    <li>The compensation program is currently under development and not yet active.</li>
                                    <li>Once launched, users may be eligible to receive payment for the profile data they provide.</li>
                                    <li>Details of the compensation structure will be communicated separately when the program is ready.</li>
